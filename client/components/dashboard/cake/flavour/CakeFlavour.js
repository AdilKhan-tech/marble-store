...
export default function ListFlavours() {
  ...
  return (
    ...
    <section className='' style={{ marginTop:"100px"}}>
      <div className=""> 
      <p className="fs-20">Cakes Flavours</p>
              ...
              <tbody>
                {cakes.map((cakes, index) => (
                  <tr key={`${cakes.id}-${index}`}>
                    <td className="text-secondary fs-16">{cakes.id}</td>
                    <td className="text-secondary fs-16">{cakes.name_en}</td>
                    <td className="text-secondary fs-16">{cakes.category_id}</td>
                    <td className="text-secondary fs-16">{cakes.slug}</td>
                    <td className="text-secondary fs-16">{cakes.additional_price}</td>
                    <td className="text-secondary fs-16">{cakes.symbol}</td>
                    ...
                    <td>
                      <div className="d-flex gap-1">
                        <button className="btn btn-sm btn-light p-2" onClick={() => showOffcanvasOnEditCakesFlavour(cakes)}>
                          <i className="bi bi-pencil text-primary"></i>
                        </button>
                        <button className="btn btn-sm btn-light p-2" onClick={() => showDeleteConfirmation(cakes.id)}>
